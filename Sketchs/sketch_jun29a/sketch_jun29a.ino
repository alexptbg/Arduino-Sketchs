...
String MAC = "90:A2:DA:F3:12:52";//7//yun
...
void loop(){
  ...
  if (client.connect(server, 80)) {
    ...
    delay(2500);
    parametri="?in=1&hum=" + String(hum) + "&temp1=" + String(temp) + "&temp2=" + String(mcp) + "&id=" + String(ID) + "&ip=" + String(IP) + "&mac=" + String(MAC);
    client.print("GET /kas/ar_in_test.php");
